...
All methods can be chained and return a new `Collection` instance.
...
The `get('Sales')` returns a Collection containing `['John Doe', 'Jane Doe']`.
...
When there are multiple modes, all are returned.
